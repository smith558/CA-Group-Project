...
class Application(tk.Frame):
    ...
    def create_widgets(self):
        ...
        def create_start_btn(master, _row=0, _column=0, width=1):
            self.startButton = tk.Button(master, text='CALCULATOR', font=helv12, command=master.process_method)
        ...
        create_start_btn(self, _row=13, _column=1, width=4)
